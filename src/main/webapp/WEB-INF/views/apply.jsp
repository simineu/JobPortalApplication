...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Job Post</a>
            </div>
	...
	<form:form action="${contextPath}/employee/apply" commandName="apply"
		method="post">
		...
		<tr>
			...
			<td><br/></td>
				...
				<td><form:textarea path="resume" rows="25" cols="100"
			...
			<tr>
				<td colspan="2"><input type="submit" value="Apply Job" /></td>
			</tr>
		</table>
