...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Start Bootstrap in Employee to message employer</a>
            </div>
	...
	<form:form action="${contextPath}/message/messageReplyEmployer" commandName="message"
		method="post">
