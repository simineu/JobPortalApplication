...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Start Bootstrap in employer to message employee</a>
            </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container">
            <div class="row">
               <h2>Message Employer</h2>

	<form:form action="${contextPath}/message/messageReplyEmployee" commandName="message"
		method="post">
		...
		<tr>
			...
			<tr>
				<td><form:textarea path="message" rows="5" cols="50"
