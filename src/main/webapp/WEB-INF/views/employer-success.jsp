            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>Hi, ${user.firstName}</h1><br />
                       <h3> <a href="${contextPath}/employer/jobPost"  style="color: white">Post New Job</a> <br /></h3>
						 <h3> <a href="${contextPath}/employer/searchJobPost" style="color: white">View Posted Jobs</a> <br /></h3>
						 <h3> <a href="${contextPath}/employer/search" style="color: white">View All Registered Employee</a> <br /></h3>
						 <h3> <a href="${contextPath}/employer/messageInbox" style="color: white" >Inbox</a> <br /></h3><br /><br />
