        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" style="margin-top:10px">Register</button>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
  ...
  <div class="modal-dialog">
	...
	<form:form action="${contextPath}/user/register" commandName="user"
		...
		<table>
			...
			<tr>
				<td>Role:</td>
				<td><form:radiobutton path="role" value="employer"/>Employer
					</td>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>Welcom To Your Job Portal</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-3 col-sm-6">
                    <img class="img-responsive" style="float:right" src="${contextPath}/resources/img/ipad.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="${contextPath}/resources/img/dog.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="${contextPath}/resources/img/phones.png" alt="">
                </div>
            </div>
    ...
    <div class="banner">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h2>Connect to our Job Portal</h2>
                </div>
                <div class="col-lg-6">
