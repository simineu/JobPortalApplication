...
<body>
	...
	<table cellpadding="5" cellspacing="5">
		<c:forEach var="a" items="${apply}">
			...
			<tr><td colspan="2"><a href="${contextPath}/employee/updateApplication.htm?ID=${a.ID}">Edit</a></td>
			
				<td colspan="2"><a href="${contextPath}/employee/deleteApplication.htm?ID=${a.ID}">Delete</a></td>
			</tr>
