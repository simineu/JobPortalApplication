...
<body>
	...
	<form:form action="${contextPath}/employer/jobPost" commandName="jobPost"
		method="post">
		...
		<tr><td><br/></td></tr>
			<tr>
				<td>Job ID:</td>
				<td><form:input path="jobID" size="50" required="required" />
			...
			<tr>
				<td>Job Title:</td>
				<td><form:input path="jobTitle" size="50" required="required" />
			...
			<tr>
				<td>Company Name:</td>
				<td><form:input path="companyName" size="50" required="required" />
			...
			<tr>
				<td>Duration:</td>
				<td><form:input path="duration" size="50" required="required" />
