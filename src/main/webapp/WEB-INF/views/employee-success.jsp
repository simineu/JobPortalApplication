            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>Hi, ${user.firstName}</h1><br />
                       <h3> <a href="${contextPath}/employee/jobPostSearch" style="color: white" >View all posted jobs</a> <br /></h3>
						 <h3> <a href="${contextPath}/employee/searchApplied" style="color: white" >View all applied jobs</a> <br /></h3>
						 <h3> <a href="${contextPath}/employee/message"  style="color: white" >Message</a> <br /></h3>
						 <h3> <a href="${contextPath}/employee/messageInbox" style="color: white" >Inbox</a> <br /></h3><br /><br />
