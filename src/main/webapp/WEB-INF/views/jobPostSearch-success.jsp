...
<body>
	...
	<table class="table table-stripped">
		<c:forEach var="j" items="${jobPost}">
			...
			<tr><td><a href="${contextPath}/employer/updatePostedJobs.htm?ID=${j.ID}">Update</a></td></tr>
			<tr><td><a href="${contextPath}/employer/viewApplied.htm?ID=${j.ID}">View who has applied</a></td></tr>
			<tr><td><a href="${contextPath}/employer/deletePostedJob.htm?ID=${j.ID}">Delete</a></td></tr>
			<tr><td><br/></td></tr>
		</c:forEach>
	</table>
